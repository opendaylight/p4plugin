...
import org.opendaylight.yang.gen.v1.urn.opendaylight.p4plugin.runtime.table.rev170808.key.field.match.type.exact.ExactValueType;
import org.opendaylight.yang.gen.v1.urn.opendaylight.p4plugin.runtime.table.rev170808.key.field.match.type.exact.exact.value.type.EXACTVALUETYPEBINARY;
import org.opendaylight.yang.gen.v1.urn.opendaylight.p4plugin.runtime.table.rev170808.key.field.match.type.exact.exact.value.type.EXACTVALUETYPESTRING;
